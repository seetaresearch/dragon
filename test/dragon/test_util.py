...
class TestDeprecation(unittest.TestCase):
    ...
    def test_deprecated(self):
        @deprecation.deprecated("2077-01-01", "This function is deprecated since 2077.")
        def func():
            pass
...
class TestNest(unittest.TestCase):
    ...
    def test_flatten(self):
        ...
        for a, b in zip(
            nest.flatten_with_paths([2, 4, [31, 32], 1]),
            [((0,), 2), ((1,), 4), ((2, 0), 31), ((2, 1), 32), ((3,), 1)],
        ):
            self.assertEqual(a, b)
        for a, b in zip(
            nest.flatten_with_paths({2: 2, 4: 4, 3: {1: 31, 2: 32}, 1: 1}),
