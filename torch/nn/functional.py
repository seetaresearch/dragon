...
from dragon.vm.torch.nn.modules import _functions
from dragon.vm.torch.nn import _reduction
from dragon.vm.torch.nn.modules import utils
...
def softmax_cross_entropy_with_logits(
    ...
    if size_average is not None or reduce is not None:
        ...
        reduction = reduction
    return _functions.SoftmaxCrossEntropy \
        .instantiate(
            input.device,
            reduction=reduction,
        ).apply([input, target])
