...
from dragon.vm.torch.utils import hooks
...
class Module(object):
    ...
    def forward(self, *inputs, **kwargs):
        ...
        """
        raise RuntimeError('The base module can not be called.')
    ...
    def zero_grad(self):
        raise RuntimeError('Module.zero_grad() is deprecated.')
