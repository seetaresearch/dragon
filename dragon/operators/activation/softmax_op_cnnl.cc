...
template <typename T>
void CNNLSoftmaxOp<Context>::DoRunWithType() {
...
template <class Context>
template <typename T>
void CNNLSoftmaxGradientOp<Context>::DoRunWithType() {
...
DEPLOY_CNNL_OPERATOR(Softmax);
DEPLOY_CNNL_OPERATOR(SoftmaxGradient);
