...
typedef MPSGraphCompilationDescriptor* MPSGraphCompilationDescriptor_t;
typedef MPSGraphRandomOpDescriptor* MPSGraphRandomOpDescriptor_t;
#else
typedef struct NSDictionary* NSDictionary_t;
typedef struct MTLDevice* MTLDevice_t;
typedef struct MTLBuffer* MTLBuffer_t;
typedef struct MTLLibrary* MTLLibrary_t;
typedef struct MTLCommandQueue* MTLCommandQueue_t;
typedef unsigned long MTLDataType_t;
typedef struct MTLComputePipelineState* MTLComputePipelineState_t;
typedef struct MTLComputeCommandEncoder* MTLComputeCommandEncoder_t;
typedef struct MTLFunctionConstantValues* MTLFunctionConstantValues_t;
typedef struct MPSCommandBuffer* MPSCommandBuffer_t;
typedef struct MPSShape* MPSShape_t;
typedef uint32_t MPSDataType_t;
typedef struct MPSGraph* MPSGraph_t;
typedef struct MPSGraphTensor* MPSGraphTensor_t;
typedef struct MPSGraphTensorData* MPSGraphTensorData_t;
typedef struct MPSGraphExecutionDescriptor* MPSGraphExecutionDescriptor_t;
typedef struct MPSGraphCompilationDescriptor* MPSGraphCompilationDescriptor_t;
typedef struct MPSGraphRandomOpDescriptor* MPSGraphRandomOpDescriptor_t;
#define nil NULL
#endif
