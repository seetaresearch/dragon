...
class GraphExecutionContext(object):
    """Context to execute a graph."""
...
class GraphLib(object):
    """Library class to build graphs from various targets."""
    ...
    def from_onnx(model, name=None):
        ...
        return GraphExecutionContext(graph_def, execute_ws)
    ...
    def _add_outputs(graph_def, outputs):
        ...
        while len(inputs) > 0:
            ...
            if input._tape:
                ...
                input._tape = None
        graph_def.op.extend(copy.deepcopy(op_tape.get_op_defs()))
    ...
    def _add_grads(graph_def, outputs):
        ...
        for serialized_str in grad_defs:
            ...
            grad_def.name = execute_ws._handle_pool.create('Op')
