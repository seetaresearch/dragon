...
def pad_exporter_v0(op_def, shape_dict, ws):
    node, const_tensors = exporter.translate(**locals())
    pads, value = [], 0
...
def pad_exporter_v1(op_def, shape_dict, ws):
    node, pads, value = pad_exporter_v0(**locals())
...
def slice_exporter_v0(op_def, shape_dict, ws):
    node, const_tensors = exporter.translate(**locals())
...
def slice_exporter_v1(op_def, shape_dict, ws):
    node, starts, ends = slice_exporter_v0(**locals())
